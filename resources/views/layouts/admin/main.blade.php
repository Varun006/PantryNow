...
<html lang="en">
    <head>
        ...
        <title>PantryNow Admin Panel</title>
    ...
    <body class="hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1>PantryNow Admin Panel</h1>
                        <small>Manage your categories, products, variations, etc from here.</small>
                        <ol class="breadcrumb">
        ...
        <!-- Start Core Plugins
        =====================================================================-->
        @include('layouts.admin.coreScripts')
        <!-- End Core Plugins
        =====================================================================-->
