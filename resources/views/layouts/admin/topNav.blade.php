                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <ul class="menu">
                            <li><!-- start message -->
                                <a href="#">
                                    <div class="pull-left"><img src="{{@asset('admin/assets/dist/img/avatar.png')}}" class="img-circle" alt="User Image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left"><img src="{{@asset('admin/assets/dist/img/avatar2.png')}}" class="img-circle" alt="User Image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left"><img src="{{@asset('admin/assets/dist/img/avatar3.png')}}" class="img-circle" alt="User Image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left"><img src="{{@asset('admin/assets/dist/img/avatar4.png')}}" class="img-circle" alt="User Image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left"><img src="{{@asset('admin/assets/dist/img/avatar5.png')}}" class="img-circle" alt="User Image"></div>
